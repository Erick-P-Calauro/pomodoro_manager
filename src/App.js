  ...
  return (
    <div className="flex justify-center h-full w-full">
      <div className="mx-2.5 max-w-[960px] flex flex-col items-center flex-grow">
        <div className="w-full space-y-12 md-mobile:grid md-mobile:grid-cols-12 md-mobile:gap-x-5">
          <div className="md-mobile:col-start-1 md-mobile:col-end-13 space-y-12">
            <Header></Header>
            <Timer></Timer>
          </div>
          
          <div className="flex flex-col space-y-6 md-mobile:col-start-2 md-mobile:col-end-12">   
