...
function Timer({}){
    ...
    return (
        <div className="px-4 pt-4 pb-7 rounded-md space-y-4 w-full flex flex-col items-center
            ...
            <button className="bg-normal rounded-sm flex items-center justify-center py-1.5 px-6 lg-mobile:py-3 lg-mobile:px-11">
